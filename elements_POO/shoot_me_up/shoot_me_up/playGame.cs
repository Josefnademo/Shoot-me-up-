...
/****************************************************************************************************** 
** DESCRIPTION                                                                                     ** 
** La classe playGame représente la principale logique de jeu pour "shoot_me_up". Elle gère         ** 
** l'ensemble des mécanismes de jeu, y compris l'affichage des éléments à l'écran, la gestion       ** 
** des entrées du joueur, et la mise à jour de l'état du jeu à chaque frame.                       ** 
**                                                                                                 ** 
** PRINCIPALES FONCTIONNALITÉS :                                                                   ** 
** - Initialiser le jeu, y compris le chargement des ressources (images, sons, etc.).               ** 
** - Gérer la boucle de jeu principale, qui met à jour l'état du jeu et redessine l'écran           ** 
**   à chaque itération.                                                                          ** 
** - Gérer les entrées utilisateur, permettant au joueur de déplacer le vaisseau et de tirer des    ** 
**   missiles.                                                                                   ** 
** - Contrôler l'apparition des ennemis et des obstacles sur l'écran.                              ** 
** - Gérer les collisions entre les missiles, les ennemis, et les obstacles.                      ** 
** - Afficher les scores et gérer les niveaux de difficulté.                                      ** 
**                                                                                                 ** 
** MÉTHODES PRINCIPALES :                                                                          ** 
** - **InitializeGame()** : Configure l'environnement de jeu, charge les ressources et initialise   ** 
**   les variables nécessaires.                                                                    ** 
** - **UpdateGame()** : Met à jour les positions des objets et vérifie les collisions à chaque      ** 
**   frame.                                                                                       ** 
** - **Render()** : Dessine tous les éléments du jeu sur l'écran, y compris le vaisseau, les      ** 
**   ennemis, et les missiles.                                                                     ** 
** - **HandleInput()** : Gère les entrées du joueur pour déplacer le vaisseau et tirer des         ** 
**   missiles.                                                                                    ** 
**                                                                                                 ** 
** La classe playGame est cruciale pour l'expérience de jeu, car elle coordonne toutes les         ** 
** interactions et les mécanismes nécessaires pour que le jeu fonctionne de manière fluide et     ** 
** engageante.                                                                                   ** 
******************************************************************************************************/
...
namespace shoot_me_up
{
            ...
            var explosionPositions = new Dictionary<Point, Func<bool>>
    {
        ...
        {
            if (obstacle == pictureBox7 && obstacle1HP > 0)
            {
                obstacle1HP--;
            ...
            if (obstacle2HP == 0) this.Controls.Remove(pictureBox8);
